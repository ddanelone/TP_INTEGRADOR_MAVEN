...
public class Graph {
	...
	private void findPaths(Vertex current, Vertex destination, List<Vertex> currentPath, Set<Vertex> visited,
	...
	public String graphToString() {
		List<Edge> sortedEdges = edges.stream().sorted(Comparator.comparingInt(e -> e.getOrigin().getValue()))
				.collect(Collectors.toList());

		StringBuilder sb = new StringBuilder();
		for (Edge edge : sortedEdges) {
			sb.append(edge.getOrigin().getValue()).append(" --> ").append(edge.getValue()).append(" --> ")
					.append(edge.getEnd().getValue()).append("\n");
		}
		return sb.toString();
	}
	...
	// Método para actualizar los vértices del grafo con la lista ordenada por
	// PageRank
